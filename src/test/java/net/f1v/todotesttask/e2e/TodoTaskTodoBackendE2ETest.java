package net.f1v.todotesttask.e2e;

import net.f1v.todotesttask.TodoBackend;
...
@SpringBootTest(classes = TodoBackend.class)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class TodoTaskTodoBackendE2ETest {
    private static final String TASKS_URL = "/api/v1/tasks";
    private static final String TASK_URL = "/api/v1/tasks/{id}";
